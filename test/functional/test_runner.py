...
if os.name != 'nt' or sys.getwindowsversion() >= (10, 0, 14393):
    if os.name == 'nt':
        ...
        kernel32.SetConsoleMode(stdout, kernel32.GetConsoleMode(stdout) | ENABLE_VIRTUAL_TERMINAL_PROCESSING)
        # Enable ascii color control to stderr
        stderr = kernel32.GetStdHandle(STD_ERROR_HANDLE)
        kernel32.SetConsoleMode(stderr, kernel32.GetConsoleMode(stderr) | ENABLE_VIRTUAL_TERMINAL_PROCESSING)
